...
@interface Team {
    ...
    int numPlayers() default 2;   // must be optional if we wish to use the shorthand i.e. "value"
}
...
class Competitor {
    ...
    @Quiz(topics= {}) String topic1;               //  {} is ok
...
class TestRainbow {
    ...
    @Colours("Red") String colour4;  // shorthand for "value" element i.e "value=" and single element array i.e. {} omitted
}

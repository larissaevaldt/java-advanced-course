...
public class UsingLists {
    ...
    public static void factoryMethods() {
        ...
        List<String> asList = Arrays.asList(array); // 'array' as 'asList' are now 'backed'. (in other words, changes in one reflect in the other)
    ...
    public static void stack() {
        ...
        // Using the stack type as the reference type so we get access to the push(), pop() anf peek() methods.
        ...
        System.out.println("Top of the stack: " + stack.peek());    // Caroline

...
public class BinarySearch {
    ...
    public static void searchString() {
        List<String> names = Arrays.asList("John", "Martin", "Paula", "Ahn");
        // the list must be sorted to use it in binarySearch
        Collections.sort(names);     // natural order sort - alphabetical order
        System.out.println(names);   // [Ahn, John, Martin, Paula]
    ...
    public static void searchCats() {
        ...
        Collections.sort(catList, byAge);    // sort by age descending

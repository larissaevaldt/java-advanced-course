...
public class Dog implements Comparable<Dog> {
     ...
     * when are used with elements (or keys) whose natural ordering is inconsistent with equals.
     */
    @Override
    public int compareTo(Dog otherDog) { // specifies the "natural ordering" for Dog
